...
const authorAge = (array) => array.map((element) => {
...
const ficBooks = (array) => array.filter((element) => element.genre !== 'Terror');

/* console.log(ficBooks(books)); */

//exercício 4: Crie um array ordenado pelos livros com mais de 60 anos de publicação e ordene-o pelo livro mais velho.
const oldBooks = (array) => array.filter(element => element.releaseYear < 1961).sort((a, b) => a.releaseYear - b.releaseYear);
...
const onlyFicBooks = ficBooks(books);

const authorNames = (array) => array.map(element => element.author.name).sort();

/* console.log(authorNames(onlyFicBooks)); */

//exercício 6: Crie um array com o nome de todos os livros com mais de 60 anos de publicação.
const booksOld = oldBooks(books);

const nameOfOldBooks = (array) => array.map(element => element.name).sort();

/* console.log(nameOfOldBooks(booksOld)); */
